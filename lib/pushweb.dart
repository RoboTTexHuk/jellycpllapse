...
class WebViewScreenPUSH extends StatefulWidget {
  String Url;
  WebViewScreenPUSH(this.Url);

  @override
  _WebViewScreenPUSHState createState() => _WebViewScreenPUSHState(Url);
}

class _WebViewScreenPUSHState extends State<WebViewScreenPUSH> {
  _WebViewScreenPUSHState(this._finalUrl);
